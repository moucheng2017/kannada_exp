...
def main(args):
    ...
    train_dataset = CharData(images=train_x, labels=train_y, transform=train_transform, classes=10)
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch, shuffle=True, drop_last=True, num_workers=4)
    ...
    for epoch in range(args.epochs):
        ...
        print('[epoch %d] loss: %.4f' % (epoch + 1, running_loss / sampling_times))
        scheduler.step()
